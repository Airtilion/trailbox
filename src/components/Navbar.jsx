...
const Navbar = () => {
    ...
    return (
        <>
            <div ref={menuRef} onClick={menuVisibilityHandle} className='hidden max-lg:flex hamburger-menu w-14 h-14 bg-white absolute flex-col justify-between items-center py-4 px-3 right-[48px] top-[64px] rounded-[10px] z-40 max-sm:right-[40px]'>
                <span className='w-8 h-1 bg-[#898989] duration-500 rounded-full'></span>
                <span className='w-8 h-1 bg-[#898989] duration-500 rounded-full'></span>
                <span className='w-8 h-1 bg-[#898989] duration-500 rounded-full'></span>
            </div>

            <nav className='relative z-20 flex justify-between items-center w-[calc(80%-100px)] h-[128px] mx-[50px] pr-[32px] top-[32px] max-2xl:pr-[24px] max-2xl:h-[112px] max-xl:mx-[20px] max-xl:w-[calc(83%-40px)] max-xl:h-[96px] max-lg:w-[calc(30%-40px)] max-lg:justify-center max-lg:pr-0 max-md:w-[calc(50%-40px)] max-sm:w-[calc(60%-20px)] max-sm:mx-[10px]'>
                <Link to="/">
                    <img src={logo} alt="Logo trailbox" width={200} className='mt-[-30px] max-2xl:w-[150px] max-2xl:mt-[-20px] max-sm:w-[140px]' />
                </Link>
                ...
                <div ref={mobileMenuRef} className='menu-mobile fixed bottom-0 left-0 w-full h-dvh bg-[#000000c1] hidden backdrop-blur-[5px] flex-col gap-[32px] justify-center items-center z-20'>
                    ...
                    <div className='flex gap-[16px] z-20 justify-center'>
                        <Link to="#">
                    ...
                    <button className='w-[250px] h-[50px] rounded-full z-20 bg-[#898989] hover:bg-[#676767] duration-300 cursor-pointer flex justify-center items-center gap-[8px]'>
