...
const ContactForm = () => {
    return (
        <section className='flex-1 relative z-10 px-[64px] py-[32px] max-xl:pb-[80px] max-md:px-[32px]'>
            ...
            <form action="" className='flex flex-wrap justify-between gap-[24px] relative z-10'>
                ...
                <div className='w-[500px] flex gap-[8px] items-start max-lg:w-full max-lg:mb-[14px]'>
                    ...
                    <label htmlFor="rulebook" class="w-5 h-5 border-2 border-[#898989] flex items-center justify-center cursor-pointer peer-checked:bg-[#898989] peer-checked:border-[#898989] transition-all duration-200">
                        <span class="hidden peer-checked:block text-white">✓</span>
                    </label>
