  ...
  return (
    <section className='w-full bg-[#F3F7F8] my-[64px] py-[64px]'>
        <article className='w-[1240px] mx-auto flex flex-col gap-[64px] max-2xl:w-[1000px] max-xl:w-[960px] max-lg:w-[90%]'>
            <div ref={ref2} className={`flex gap-[64px] max-lg:flex-col max-lg:gap-[16px] transition-all duration-1000 ease-in-out ${isVisible2 ? 'element-visible-bottom' : 'element-hidden-bottom'}`}>
