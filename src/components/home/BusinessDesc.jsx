...
const BusinessDesc = () => {
  return (
    <section className='w-[1240px] mx-auto flex flex-col gap-[80px] mt-[32px] max-2xl:w-[1000px] max-xl:w-[960px] max-lg:w-[90%] max-sm:gap-[64px]'>
        <article className='w-full flex gap-[96px] max-lg:flex-col-reverse max-md:gap-[64px]'>

            <div className='rounded-[40px] flex-1 relative max-lg:w-[600px] max-lg:mx-auto max-md:w-[90%] max-lg:rounded-[30px] max-sm:w-full'>
                ...
                <span className='dotted w-[170px] h-[170px] bg-red-500 absolute bottom-[-30px] right-[-30px] z-0 max-md:w-[120px] max-md:h-[120px] max-sm:bottom-[-18px] max-sm:right-[-18px]'></span>
            </div>

            <div className='flex-1 flex flex-col gap-[16px] self-end max-lg:w-[90%] max-lg:mx-auto max-sm:w-full'>
        ...
        <article className='w-full flex flex-col items-center gap-[16px] max-lg:w-[90%] max-lg:mx-auto max-sm:w-full'>
            ...
            <button className='rounded-full bg-[#898989] text-white text-[18px] h-[50px] px-[48px] max-xl:text-[16px]'>Napisz do nas</button>
        </article>
    </section>
  )
}
